...
const BUILD_PATH = "./build/server/app.js";
...
async function setupDevelopmentServer(app) {
  ...
  // Handle our custom routes BEFORE Vite middleware
  app.use(async (req, res, next) => {
    try {
      // Let Vite handle its internal routes first
  ...
  // Add Vite middleware last to handle asset requests
